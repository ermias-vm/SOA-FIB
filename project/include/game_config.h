...
#define FYGAR_FIRE_COOLDOWN 60      /* Ticks between fire attacks */
#define FYGAR_FIRE_DURATION 10      /* Ticks fire stays active */
...
#define INFLATE_DEFLATE_TIME 30     /* Ticks to deflate one level */
...
#define TICKS_PER_SECOND    18      /* ~18 Hz timer frequency */
#define TARGET_FPS          15      /* Target game FPS */
#define ROUND_START_DELAY   60      /* Ticks to wait at round start */
#define DEATH_DELAY         30      /* Ticks to wait after death */
